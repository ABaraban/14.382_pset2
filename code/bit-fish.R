...
filepathVictor<-"/Users/chernoz/Dropbox/TEACHING/14.382"
filepathMatej = "/Users/mcerman/Documents/2 Class/14.382/14.382_pset2/"
filepath<-filepathMatej
...
data <- as.data.frame(read.csv(paste(filepath,"/data/Fish/bigfish.csv",sep=""), header=T ));
attach(data);
