...
To show that we can simulate such a system, 
...
\textbf{Deriving unconditional moment restrictions:} Now we seek to convert these conditional moment restriction into unconditional moment restrictions. To do so, let
\begin{align*}
    B(Z_t) \coloneq [B_1(Z_t), \ldots,B_r(Z_t)]' \in \R^r
\end{align*}
be a vector of transformations of $Z_t.$ Next, consider the Kronecker product of the conditional moments and $B(Z_t)$, which will be a column vector of length $Jm$ where each ent
\begin{align*}
